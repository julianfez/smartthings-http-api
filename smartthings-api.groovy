...
definition(
  name: "SmartThings API Endpoint",
  namespace: "jshimko",
  author: "Jeremy Shimko",
  description: "HTTP API access to SmartThings.",
  category: "My Apps",
  iconUrl: "https://s3.amazonaws.com/smartapp-icons/Convenience/Cat-Convenience.png",
  iconX2Url: "https://s3.amazonaws.com/smartapp-icons/Convenience/Cat-Convenience@2x.png",
  oauth: [displayName: "SmartThings API Endpoint", displayLink: ""]
)
...
// Callback to send events to some url
private logField(evt, Closure c) {
  httpPostJson(uri: "https://api.myapp.com/events/${evt.deviceId}/${evt.name}.json",   body:[device: evt.deviceId, name: evt.name, value: evt.value, date: evt.isoDate, unit: evt.unit]) {
